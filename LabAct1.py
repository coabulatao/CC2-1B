...
print("In the end, it was " + names[4] + " who delivered the final blow with " + ability[1] +", shattering the " + item + " and defeating " + names[0] + ". The realm of " + place + " was saved from eternal darkness, thanks to the combined effort of " + names[1] + ", " + names[4] + ", " + names[2] + ", " + names[3] + ", and " + names[5] + ".")
